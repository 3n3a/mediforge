...
Environment:
  MEDIA_LIBRARIES, WORKER_URL, WORKER_TOKEN, ARCHIVE_MODE, ARCHIVE_DIR,
  MAX_RETRIES, MEDIFORGE_DB, HTTP_TIMEOUT_UPLOAD, HTTP_TIMEOUT_ENCODE,
  MEDIA_EXTENSIONS, LOG_LEVEL, JELLYFIN_INTEGRATION_ENABLED, JELLYFIN_URL,
  JELLYFIN_API_KEY`)
}
